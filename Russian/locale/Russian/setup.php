...
$locale['setup_0006'] = "PHP-Fusion 9 требует как минимум PHP 5.5.9. Посмотрите <a href='https://www.php-fusion.co.uk/infusions/wiki/documentation.php?page=215'>системные требования</a> для подробной информации.";
...
$locale['setup_0113'] = "Ваша установленная копия PHP слишком старая. PHP-Fusion требует как минимум версии 5.6.8. Версии PHP выше 5.6.8 обеспечивают встроенную защиту от SQL-инъекций для баз данных MySQL. Рекомендуем Вам обновить свою версию.";
