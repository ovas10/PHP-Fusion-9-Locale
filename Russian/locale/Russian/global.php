...
$locale["global_130"] = "Панель не найдена";
// Member User Menu
$locale['UM060'] = "Логин";
$locale['UM061'] = "Логин";
...
Ваша учётная запись на сайте «[SITENAME]»  была замечена в слишком частой публикации записей за короткий отрезок времени с IP-адреса [USER_IP] и по этой причине была заблокирована. Это было сделано для защиты от массового размещения ботами спам-сообщений.<br/>
Свяжитесь с администратором по Е-майлу: [SITE_EMAIL] для восстановления Вашей учётной записи или для информирования о том, что Вы не размещали сообщений.<br/>
...
// Misc
$locale['max_fs_allowed_ft'] = "Maкс. размер файла %s / Разрешённые типы файлов %s";
// Timer
